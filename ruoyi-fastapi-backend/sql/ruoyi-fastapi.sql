...
insert into sys_menu values('120',  '知识库',   '4',   '3', 'knowledge',  'ai/knowledge/index',       '', '', 1, 0, 'C', '0', '0', 'ai:knowledge:list',       'documentation', 'admin', sysdate(), '', null, '知识库菜单');
-- 三级菜单
...
insert into sys_menu values('1065', '知识库查询', '120', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'ai:knowledge:query',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1066', '知识库上传', '120', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'ai:knowledge:upload',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1067', '知识库删除', '120', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'ai:knowledge:remove',      '#', 'admin', sysdate(), '', null, '');
...
insert into sys_config values(2, '用户管理-账号初始密码',         'sys.user.initPassword',         'Temp@1234',     'Y', 'admin', sysdate(), '', null, '初始化密码 Temp@1234' );
